...
import com.github.saiyedriyaz.service.forex.currency.util.RestUtil;
...
public class TestCurrencyController {
    ...
    private GenericData createDummyResponse(String date, String value) {
        ...
        var series = Series.builder()
                .seriesKey(SeriesKey.builder().valueList(List.of(new com.github.saiyedriyaz.service.forex.currency.domain.external.Value("BBK_STD_CURRENCY", "CHF"))).build())
